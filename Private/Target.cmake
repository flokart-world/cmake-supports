...
function (CMS_DEFINE_TARGET _name)
  ...
  CMS_DEFINE_PROPERTY(BuildEvents)
  ...
  CMS_SET_PROPERTY(BuildEvents 0)
endfunction ()
...
function (CMS_ADD_BUILD_EVENT)
  if (ARGN)
    CMS_GET_PROPERTY(_eventId BuildEvents)
    math (EXPR _numBuildEvents "${_eventId} + 1")
    CMS_SET_PROPERTY(BuildEvents "${_numBuildEvents}")

    set (_name "BuildEvent[${_eventId}]")
    CMS_DEFINE_PROPERTY("${_name}")
...
function (CMS_SUBMIT_TARGET _name)
  ...
  CMS_GET_PROPERTY(_buildEvents BuildEvents)
  CMS_GET_PROPERTY(_dependencies Dependencies)
  ...
  if (_buildEvents GREATER 0)
    math (EXPR _maxEventId "${_buildEvents} - 1")
    foreach (_eventId RANGE ${_maxEventId})
      CMS_GET_PROPERTY(_buildEvent "BuildEvent[${_eventId}]")
      add_custom_command (TARGET ${_name} ${_buildEvent})
    endforeach ()
  endif ()
