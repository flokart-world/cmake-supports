...
function (CMS_DEFINE_TARGET _name)
  ...
  CMS_DEFINE_SCOPE_PROPERTY(GeneratedFiles)
  CMS_DEFINE_SCOPE_PROPERTY(LinkFlags)
  CMS_DEFINE_SCOPE_PROPERTY(LinkerLanguage)
  CMS_DEFINE_SCOPE_PROPERTY(OutputName)
  CMS_DEFINE_SCOPE_PROPERTY(OutputSuffixDebug)
  CMS_DEFINE_SCOPE_PROPERTY(OutputSuffixVersion)
  CMS_DEFINE_SCOPE_PROPERTY(SourceFiles)
  ...
  foreach (_group IN LISTS _groups)
    ...
    CMS_DEFINE_SCOPE_PROPERTY(${_name})
...
function (CMS_DEFINE_SOURCE_FILE_PROPERTIES _fullPath)
  ...
  CMS_DEFINE_SCOPE_PROPERTY("${_prefix}CompileDefinitions")
  CMS_DEFINE_SCOPE_PROPERTY("${_prefix}CompileOptions")
endfunction ()
